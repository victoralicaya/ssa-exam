            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('users.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label for="prefixname" class="col-md-4 col-form-label text-md-end">{{ __('Prefix') }}</label>

                            <div class="col-md-6">
                                <select name="prefixname" id="" class="form-select" autofocus>
                                    <option value=""></option>
                        ...
                        <div class="row mb-3">
                            <label for="password" class="col-md-4 col-form-label text-md-end">{{ __('Photo') }}</label>

                            <div class="col-md-6">
                                <input id="password" type="file" class="form-control @error('photo') is-invalid @enderror" name="photo" autocomplete="photo">
