                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('users.update', $user->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select name="prefixname" id="" class="form-select @error('prefixname') is-invalid @enderror" autocomplete="prefixname" autofocus>
                                    <option value=""></option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="middlename" type="text" class="form-control" name="middlename" value="{{ $user->middlename }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="suffixname" type="text" class="form-control" name="suffixname" value="{{ $user->suffixname }}">
